	...
	<body>
		<div class="page">
			<div id="header">
				...
				<ul id="navigation">
					<li class="selected first"><a href="index.jsp">Home</a></li>
			...
			<div id="content">
				<div id="home">
					<ul>
						<li><a href="japanese.jsp"><img src="images/japanese.jpg" alt=""></a></li>
						<li><a href="chinese.jsp"><img src="images/chinese.jpg" alt=""></a></li>
						<li><a href="filipino.jsp"><img src="images/filipino.jpg" alt=""></a></li>
						<li><a href="vietnamese.jsp"><img src="images/vietnamese.jpg" alt=""></a></li>
						<li><a href="korean.jsp"><img src="images/korean.jpg" alt=""></a></li>
					</ul>					
					<div class="first">
					...
					<div>
						<a href="blog.jsp"><img src="images/main-dish.jpg" alt=""></a>
			...
			<div id="footer">
				<div>
					<div class="section1">
						<a href="blog.jsp"><img src="images/health-benefits.jpg" alt=""></a>
						<h4>Health Benefits</h4>
						<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy ut lao 
						magna. <a href="blog.jsp">Read More</a></p>
					</div>
					<div class="section2">
						<a href="blog.jsp"><img src="images/mixed-rice.jpg" alt=""></a>
						<p><span>Lorem ipsum</span> dolor sit amet, consectetuer adipiscing elit, sed diam nonummy
						nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi 
						enim ad minim veniam, quis nostrud. <a href="blog.jsp">Read More</a></p>
					</div>
					<div class="section3">
						<a href="blog.jsp"><img src="images/mixed-rice2.jpg" alt=""></a>
						<p><span>Lorem ipsum</span> dolor sit amet, consectetuer adipiscing elit, sed diam nonummy
						nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi 
						enim ad minim veniam, quis nostrud. <a href="blog.jsp">Read More</a></p>
					</div>
