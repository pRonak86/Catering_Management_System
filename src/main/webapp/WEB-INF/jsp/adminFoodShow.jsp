...
<body>
  ...
  <path fill-rule="evenodd"
					...
					<li><a href="adminOrderDetails"><svg
								class="bi bi-card-checklist" width="1em" height="1em"
								viewBox="0 0 16 16" fill="currentColor"
								xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd"
		...
		<div id="page-wrapper">
			<div id="page-inner">
				...
				<div class="row">
					<div class="col-lg-12 ">
						<div class="alert alert-info">
							<a href="adminFood">Add More Food</a>
						</div>
								...
								<tbody>
									<c:forEach var="food" items="${food }">
										<tr>
											...
											<td><a href="editFood?a_fid=${food.a_fid }">Edit</a></td>
											<td><a href="deleteFood/${food.a_fid }">Delete</a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
