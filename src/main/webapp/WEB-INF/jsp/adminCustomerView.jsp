		...
		<div id="page-wrapper">
			<div id="page-inner">
				...
				<div class="row">
					<div class="col-lg-12 ">
						<div class="alert alert-info">
							<form action="acustdetails" method="post">
								<table class="table">
									<thead class="thead-dark">
										<tr bgcolor="#EEE8AA" color="white">
											<td>Name</td>
											<td><input type="text" name="cname"
												placeholder="${c.cname }" readonly="readonly">
										</tr>
										<tr bgcolor="#EEE8AA" color="white">
											<td>Contact</td>
											<td><input type="text" name="cname"
												placeholder="${c.ccontact }" readonly="readonly">
										</tr>
										<tr bgcolor="#EEE8AA" color="white">
											<td>Email</td>
											<td><input type="text" name="cname"
												placeholder="${c.cemail }" readonly="readonly">
										</tr>
										<tr bgcolor="#EEE8AA" color="white">
											<td>UserName</td>
											<td><input type="text" name="cname"
												placeholder="${c.cuser }" readonly="readonly">
										</tr>
										<tr bgcolor="#EEE8AA" color="white">
											<td>Password</td>
											<td><input type="text" name="cname"
												placeholder="${c.pass }" readonly="readonly">
										</tr>
										<tr bgcolor="#EEE8AA" color="white">
											<td colspan="2" align="center"><input type="Submit" name="Submit" value="Back">
										</tr>
									</thead>
